...
const zh: TranslationDict = {
  ...
  'pipeline.uploadingAudio': '正在上传音频文件...',
  'pipeline.asrTaskSubmitted': '识别任务已提交，等待处理...',
  'pipeline.asrTaskPolling': '语音识别处理中...',
  'pipeline.asrTaskDownloading': '正在下载识别结果...',
  ...
  'settings.asr.legend': '语音识别',
  'settings.asr.providerLocal': '本地ASR (FunASR)',
  'settings.asr.providerAliyun': '阿里云语音识别服务',
  ...
  'settings.aliyunAsr.modelPlaceholder': '模型',
