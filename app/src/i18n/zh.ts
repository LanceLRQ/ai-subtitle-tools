...
const zh: TranslationDict = {
  ...
  'pipeline.asrSubmitted': 'ASR 任务已提交: {taskId}',
  'pipeline.asrPolling': '识别中: {progress}%',
  'pipeline.asrTaskFailed': 'ASR 任务失败: {error}',
  ...
  'settings.asr.provider': '服务提供方',
  'settings.asr.healthCheck': '健康检查',
  'settings.asr.healthChecking': '检查中...',
  'settings.asr.healthDevice': '设备: {device}',
  'settings.asr.healthModel': '模型: {model}',
  'settings.asr.healthAlign': '逐字对齐: {status}',
  'settings.asr.healthPunc': '标点恢复: {status}',
  'settings.asr.healthBackend': 'ASR 后端: {backend}',
