...
const en: TranslationDict = {
  ...
  'pipeline.asrSubmitted': 'ASR task submitted: {taskId}',
  'pipeline.asrPolling': 'Recognition in progress: {progress}%',
  'pipeline.asrTaskFailed': 'ASR task failed: {error}',
  ...
  'settings.asr.provider': 'Provider',
  'settings.asr.healthCheck': 'Health Check',
  'settings.asr.healthChecking': 'Checking...',
  'settings.asr.healthDevice': 'Device: {device}',
  'settings.asr.healthModel': 'Model: {model}',
  'settings.asr.healthAlign': 'Word Alignment: {status}',
  'settings.asr.healthPunc': 'Punctuation: {status}',
  'settings.asr.healthBackend': 'ASR Backend: {backend}',
