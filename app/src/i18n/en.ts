...
const en: TranslationDict = {
  ...
  'pipeline.uploadingAudio': 'Uploading audio file...',
  'pipeline.asrTaskSubmitted': 'Recognition task submitted, waiting...',
  'pipeline.asrTaskPolling': 'Processing speech recognition...',
  'pipeline.asrTaskDownloading': 'Downloading recognition results...',
  ...
  'settings.asr.legend': 'Speech Recognition',
  'settings.asr.providerLocal': 'Local ASR (FunASR)',
  'settings.asr.providerAliyun': 'Aliyun DashScope',
  ...
  'settings.aliyunAsr.apiKeyPlaceholder': 'API Key',
  'settings.aliyunAsr.modelPlaceholder': 'Model',
